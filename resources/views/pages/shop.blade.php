                        ...
                        @foreach($products as $product)
                            <div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
                                <div class="product d-flex flex-column">
                                    <a href="test" class="img-prod"><img class="img-fluid" src="{{ $product->images }}" alt="Colorlib Template">
                                    ...
                                    <div class="text py-3 pb-4 px-3">
                                        ...
                                        <h3><a href="test">{{ $product->name }}</a></h3>
                                        <div class="pricing">
                                            <p class="price"><span>Tk. {{ $product->price }}</span></p>
                                        </div>

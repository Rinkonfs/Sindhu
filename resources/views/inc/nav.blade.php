...
{{--          <li class="nav-item cta cta-colored"><a href="cart" class="nav-link"><span class="icon-shopping_cart"></span>{{ count((array) session('cart')) }}</a></li>--}}
            ...
            <li class="nav-item dropdown cta cta-colored">
                <a class="nav-link dropdown-toggle" href="cart" id="dropdown05" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="icon-shopping_cart"></span>{{ count((array) session('cart')) }}</a>
                <div >
